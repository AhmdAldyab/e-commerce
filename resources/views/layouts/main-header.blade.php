        ...
        <div class="main-header-right">
            @if (!Auth::check())
                <div class="nav nav-item  navbar-nav-right ml-auto">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-rotate-bottom" data-toggle="modal" href="#modaldemo82">Login</a>  
                </div>
                &nbsp;
                <div class="nav nav-item  navbar-nav-right ml-auto">
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-rotate-bottom" data-toggle="modal" href="#modaldemo81">Register</a>
                </div>
            @endif
            <ul class="nav">
                <li class="">
